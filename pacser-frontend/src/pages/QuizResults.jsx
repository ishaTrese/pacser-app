  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 font-sans pb-12 transition-colors">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 sm:py-8">
        ...
        <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-3xl p-5 sm:p-8 md:p-12 text-center shadow-sm mt-4 relative overflow-hidden">
