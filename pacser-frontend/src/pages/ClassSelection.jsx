    ...
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
      ...
      <div className="flex-1 flex flex-col max-w-5xl w-full mx-auto px-6 py-12 justify-center">
        ...
        <div className="text-center mb-12">
          <h1 className="text-slate-900 font-black text-4xl mb-4 tracking-tight">
            Select Your <span className="text-blue-600">Category</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <button 
            ...
            className="group relative bg-white rounded-3xl border-2 border-slate-200 p-8 shadow-sm hover:border-blue-500 hover:shadow-xl hover:shadow-blue-600/10 transition-all duration-300 flex flex-col items-center text-center h-full hover:-translate-y-1 overflow-hidden"
          >
            {/* Default State */}
            <div className="flex flex-col items-center transition-all duration-300 group-hover:opacity-0 group-hover:-translate-y-4 absolute inset-0 p-8 justify-center">
              <div className="w-24 h-24 rounded-full bg-blue-50 border-4 border-white shadow-sm flex items-center justify-center mb-6">
                <Briefcase className="text-blue-600" size={40} />
              </div>
              <h2 className="text-slate-900 font-extrabold text-2xl mb-3 tracking-tight">Professional</h2>
            ...
            <div className="flex flex-col h-full w-full opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 text-left">
              <h3 className="font-extrabold text-slate-900 text-xl mb-4 flex items-center gap-2">
                <Briefcase className="text-blue-600" size={24} /> Professional Coverage
              </h3>
              <ul className="space-y-3 mb-8">
                {profContent.map((item, idx) => (
                  <li key={idx} className="flex items-start gap-2 text-slate-600 font-medium text-sm">
          ...
          <button 
            ...
            className="group relative bg-white rounded-3xl border-2 border-slate-200 p-8 shadow-sm hover:border-blue-500 hover:shadow-xl hover:shadow-blue-600/10 transition-all duration-300 flex flex-col items-center text-center h-[420px] hover:-translate-y-1 overflow-hidden"
          >
            {/* Default State */}
            <div className="flex flex-col items-center transition-all duration-300 group-hover:opacity-0 group-hover:-translate-y-4 absolute inset-0 p-8 justify-center">
              <div className="w-24 h-24 rounded-full bg-blue-50 border-4 border-white shadow-sm flex items-center justify-center mb-6">
              ...
              <h2 className="text-slate-900 font-extrabold text-2xl mb-3 tracking-tight">Sub-Professional</h2>
              <p className="text-slate-500 font-medium px-4">
            ...
            <div className="flex flex-col h-full w-full opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 text-left">
              <h3 className="font-extrabold text-slate-900 text-xl mb-4 flex items-center gap-2">
                <FileText className="text-blue-600" size={24} /> Sub-Prof Coverage
              </h3>
              <ul className="space-y-3 mb-8">
